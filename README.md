...
* Kubernetes cluster provisioner with [Cluster API](https://cluster-api.sigs.k8s.io/)
* CAPVCD MultiAZ collaboration [CAPVCD MultiAZ](https://github.com/vmware/cluster-api-provider-cloud-director/tree/multiAZ)
...
* Kubernetes-native authorization service [Authorino](https://github.com/Kuadrant/authorino)
* Operator to manage deployment of Authorino's instances [Authorino Operator](https://github.com/Kuadrant/authorino-operator)
* Kubernetes Operator for installing and reconciling managed products. [Integreatly Operator](https://github.com/integr8ly/integreatly-operator)

### Senior Software Engineer at Qpercom

Dec ‘15 – Jul '19

* Tech leader of an innovative project in the assessment area.
* Started from scratch the development of a REST API using PHP framework Laravel 5+, MySQL database, testable with PHPunit and Postman, docker images for deployment and
local development.
...
* Created a web interface fully developed in JavaScript using Angular JS, CSS3, LESS, Gulp,
Bower and HTML5.
...
### Web Developer at Acumuladores Moura - LTDA
